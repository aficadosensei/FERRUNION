...
<main class="bg-gray-50 flex flex-col min-h-screen">
    <div class="relative bg-gray-900 h-64 flex items-center justify-center overflow-hidden">
        <img src="https://img.freepik.com/foto-gratis/escala-grises-angulo-edificio-arquitectura-brutalista-moderna-luz-sol_181624-21352.jpg?semt=ais_hybrid&w=740&q=80" class="absolute inset-0 w-full h-full object-cover opacity-50" alt="Construcción">
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="product-card">
                <div class="h-56 hover-zoom-container">
                    <img src="https://www.pegaduro.com.mx/img/Pegaduro-Blog/Blog_243.jpg" class="hover-zoom-container" alt="Agregados">
                </div>
                <div class="p-6">
